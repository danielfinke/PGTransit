...
public class TimesAdapterTest extends AndroidTestCase {
	...
	public void testGetCount() {
		mAdapter = new TimesAdapter(getContext());
		assertEquals(mAdapter.getCount(), 0);
		ArrayList<TimeSlot> items = new ArrayList<TimeSlot>();
		items.add(new TimeSlot(0, null, null, null, 0, 0));
		items.add(new TimeSlot(1, null, null, null, 0, 0));
		mAdapter.setSlots(items);
	...
	public void testGetItem() {
		...
		ArrayList<TimeSlot> items = new ArrayList<TimeSlot>();
		TimeSlot b0 = new TimeSlot(0, null, null, null, 0, 0);
		items.add(b0);
		items.add(new TimeSlot(1, null, null, null, 0, 0));
		mAdapter.setSlots(items);
	...
	public void testGetView() {
		...
		TimeSlot b0 = new TimeSlot(0, null, null, time1, 0, nextDayFlag ? 1 : 0);
		items.add(b0);
		mAdapter.setSlots(items);
	...
	/**
	 * Test method for {@link com.finke.pgtransit.adapters.TimesAdapter#setSlots(java.util.List)}.
	 */
	public void testSetSlots() {
		mAdapter = new TimesAdapter(getContext());
		ArrayList<TimeSlot> items = new ArrayList<TimeSlot>();
		TimeSlot b0 = new TimeSlot(0, null, null, null, 0, 0);
		TimeSlot b1 = new TimeSlot(1, null, null, null, 0, 0);
		items.add(b0);
		items.add(b1);
		mAdapter.setSlots(items);
		assertEquals(mAdapter.getItem(0), b0);
