...
public class RoutesAdapterTest extends AndroidTestCase {
	...
	public void testGetCount() {
		...
		items.add(new Bus(0, "name", 0, 0, "to direction", "#101010"));
		items.add(new Bus(1, "name", 0, 0, "to direction", "#101010"));
	...
	public void testGetItem() {
		...
		ArrayList<Bus> items = new ArrayList<Bus>();
		Bus b0 = new Bus(0, "name", 0, 0, "to direction", "#101010");
		items.add(b0);
		items.add(new Bus(1, "name", 0, 0, "to direction", "#101010"));
		mAdapter.setItems(items);
	...
	public void testSetItems() {
		...
		ArrayList<Bus> items = new ArrayList<Bus>();
		Bus b0 = new Bus(0, "name", 0, 0, "to direction", "#101010");
		Bus b1 = new Bus(1, "name", 0, 0, "to direction", "#101010");
		items.add(b0);
		items.add(b1);
		mAdapter.setItems(items);
		assertEquals(mAdapter.getItem(0), b0);
